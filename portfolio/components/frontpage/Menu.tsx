  ...
  return (
    <Link href={href}>
      <div className="group relative">
        ...
        <p className=" text-sky-700 opacity-80 text-4xl md:text-6xl rounded-full font-handel py-4 transition duration-300 ease-in-out group-hover:scale-105 group-hover:text-white group-hover:opacity-100 group-hover:text-shadow-lg shadow-sky-600">
          {text}
        </p>
      </div>
    </Link>
