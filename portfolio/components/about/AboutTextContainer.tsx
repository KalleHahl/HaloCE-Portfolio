...
const AboutTextContainer = () => {
  return (
    <div className="lg:w-full mt-5 xl:mt-0 mx-5 overflow-y-auto scrollbar-thin scrollbar-thumb-rounded-full scrollbar-track-transparent scrollbar-thumb-sky-500 px-5 py-5 xl:px-10 xl:py-10 border-4 rounded-xl border-sky-500 bg-black bg-opacity-30 max-h-screen ">
      <ReactTyped
        strings={[
        ...
        backSpeed={50}
        cursorChar=""
        className="text-sky-500 font-bold text-s xl:text-3xl "
      />
    </div>
  )
}
